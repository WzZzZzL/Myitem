<template>
    ...
    <div class="ep">
        ...
        <div class="sellCard"  @click="toCard1">
        ...
        <div class="sellCard" @click="toSet">
...
export default {
    ...
    methods:{
        ...
        toLogin(){
            ...
            if(islog){
                ...
                this.$router.push('/center/centerloginpage')
            }   
        },
        toSet(){
            let islog=JSON.parse(localStorage.getItem('islog'))
        ...
        toCard2(){
            let islog=JSON.parse(localStorage.getItem('islog'))
            if(islog){
                this.$router.push('/center/redPacket')
            }else{
                this.$router.push('/center/centerloginpage')
            }
        },
    ...
    mounted(){
        ...
        if(islog){
            ...
            this.islogImg=this.ok
        }else{
            this.username='立即登录'
            this.islogImg=this.fail
        }
    }
}
</script>
